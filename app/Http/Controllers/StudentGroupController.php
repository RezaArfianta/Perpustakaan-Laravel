...
class StudentGroupController extends Controller
{
    ...
    public function search(Request $request, StudentGroup $studentGroup)
    {
        $keyword = $request->searchstudentgroups;
        $studentGroups = StudentGroup::where('rombel', 'like', "%" . $keyword . "%")->paginate(5);
